...
const lcCommand gCommands[] =
{
	...
	// LC_EDIT_FIND
	{
		...
		QT_TRANSLATE_NOOP("Status", "Find piece - Ctrl+Shift+F"),         /*** LPub3D Mod - LPub3D Menu update ***/
		"Ctrl+Shift+F"                                                    /*** LPub3D Mod - LPub3D Menu update ***/
	},
	// LC_EDIT_FIND_NEXT
	{
...
/*** LPub3D Mod - transform command ***/
	 // LC_EDIT_ACTION_ROTATESTEP
	{
		...
		QT_TRANSLATE_NOOP("Status", "Apply myLPub3D ROTSTEP command to this STEP"),
		"Shift+R"
	},
